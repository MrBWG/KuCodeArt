...
function preload(){
	...
	imageCanary = loadImage('./canary500.png');
}
...
function draw() {
	...
	image(imageCanary, width/2-255, height/2-200+offsetY, imageCanary.width, imageCanary.height);
	if(runCount > 300)
		drawLight(imageCanary, width/2-255, height/2-200+offsetY, imageCanary.width, imageCanary.height, lightIndex);
